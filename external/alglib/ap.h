...
#if !defined(AE_NO_EXCEPTIONS)
bool try_parallelize_v2request2(rcommv2_request &request, rcommv2_callbacks &callbacks);
bool try_parallelize_v2request3(rcommv2_request &request, rcommv2_callbacks &callbacks);
bool try_parallelize_v2request4(rcommv2_request &request, rcommv2_callbacks &callbacks);
#endif
